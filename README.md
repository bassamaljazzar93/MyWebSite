...
### AI Chatbot System
```javascript
- POST and GET fallback for reliability
- Automatic prompt extraction from AI responses
- Settings auto-application (model, size, seed)
...
Image Generation
javascript- Pollinations.AI image API integration
- Dynamic URL construction with parameters
- Seed-based variation system
- High-quality download functionality
- Gallery management with actions
- Model selection (6+ options)
Multi-Language System
javascript- data-en and data-ar attributes for all text
- Automatic direction change (dir="rtl" / dir="ltr")
- Placeholder translation for inputs
- Dynamic content updates without reload
- Language persistence across sessions
📁 Project Structure
portfolio/
├── index.html                 # Main portfolio page
├── ai-playground.html         # AI tools playground
├── README.md                  # This file
└── assets/
    └── (3D models via Spline CDN)
🚀 Getting Started
Option 1: Use as Template

Fork this repository
Update personal information in index.html
Replace 3D model URL with your Spline design
Update Google Sheets URL for analytics (optional)
...
Simply upload index.html and ai-playground.html to any web hosting service.
🔧 Customization Guide
Update Personal Info
Edit the following sections in index.html:

Hero section (name, title, description)
About section (education, location, interests)
Experience cards (job history)
Projects (your work)
Skills (technical abilities)
Contact information

Change AI Behavior
Modify the systemPrompt variable in the chatbot script to change AI personality and knowledge base.
Update 3D Model
Replace the Spline viewer URL:
html<spline-viewer url="YOUR_SPLINE_URL"></spline-viewer>
Analytics Setup
Update GOOGLE_SHEET_URL with your Google Apps Script URL.
🎨 Color Customization
Edit CSS variables in the :root selector:
css--primary: #00d9ff;      /* Cyan */
--secondary: #7c3aed;    /* Purple */
--accent: #f59e0b;       /* Orange */
--bg-dark: #0a0e27;      /* Dark Blue */
--bg-darker: #050816;    /* Darker Blue */
📊 Features Comparison
